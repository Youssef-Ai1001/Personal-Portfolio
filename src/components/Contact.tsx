              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">+20 1025 555 555</p>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="flex items-center space-x-4">
                  <a
                    ...
                    className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center text-white hover:bg-gray-700 transition-all duration-200 hover:scale-110 shadow-lg"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white hover:bg-blue-700 transition-all duration-200 hover:scale-110 shadow-lg"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-cyan-500 rounded-full flex items-center justify-center text-white hover:bg-cyan-600 transition-all duration-200 hover:scale-110 shadow-lg"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-black rounded-full flex items-center justify-center text-white hover:bg-gray-800 transition-all duration-200 hover:scale-110 shadow-lg"
                  >
                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <a
                    href="https://wa.me/201025555555"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center text-white hover:bg-green-600 transition-all duration-200 hover:scale-110 shadow-lg"
                  >
                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
