...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-white dark:bg-gray-900 scroll-animate">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="flex items-center justify-center lg:justify-start space-x-3">
                  <a
                    ...
                    className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center text-white hover:bg-green-600 transition-all duration-300 hover:scale-110 shadow-lg hover:shadow-xl opacity-50 cursor-not-allowed"
                  >
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center px-6 py-3 bg-green-500 text-white font-semibold rounded-lg shadow-lg opacity-50 cursor-not-allowed"
          >
